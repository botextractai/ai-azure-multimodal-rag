...
# Initialize AzureOpenAIMultiModal
...
async def setup():
    ...
    await cl.Message(
        content="Hello! I'm ready to help you perform Multimodal RAG using LlamaIndex, Azure AI Search, and Azure OpenAI over the AI Report. What would you like to know?",
        author="Assistant"
    ).send()
